...
public class Location {
	...
	public Location floor() {
		...
		double latFloor = Math.floor(getLatitude() / com.example.bearbit.egm96.Geoid.LATITUDE_STEP) * com.example.bearbit.egm96.Geoid.LATITUDE_STEP;
		double lngFloor = Math.floor(getLongitude() / com.example.bearbit.egm96.Geoid.LATITUDE_STEP) * com.example.bearbit.egm96.Geoid.LATITUDE_STEP;
